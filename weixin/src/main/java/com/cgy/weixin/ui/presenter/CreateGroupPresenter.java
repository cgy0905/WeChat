...
import com.cgy.weixin.ui.view.ICreateGroupView;
import com.cgy.weixin.utils.LogUtils;
import com.cgy.weixin.utils.SortUtils;
...
public class CreateGroupPresenter extends BasePresenter<ICreateGroupView>{
    ...
    public CreateGroupPresenter(BaseActivity context) {
        super(context);
    }
        ...
        ApiRetrofit.getInstance().createGroup(mGroupName, selectedIds)
                ...
                .subscribe(createGroupResponse -> {
                    ...
                    if (createGroupResponse.getCode() == 200) {
                        ...
                        DBManager.getInstance().saveOrUpdateGroup(new Groups(result.getId(), mGroupName, null, String.valueOf(0)));
