...
import com.cgy.weixin.ui.presenter.MyLocationPresenter;
 ...
 * 2018/6/6  13:52
 */
public class MyLocationActivity extends BaseActivity<IMyLocationView, MyLocationPresenter> implements IMyLocationView, TencentLocationListener, SensorEventListener{
    ...
    private void search(LatLng latLng) {
        ...
        mTencentSearch.geo2address(geo2AddressParam, new HttpResponseListener() {
            ...
            public void onSuccess(int i, BaseObject baseObject) {
                ...
                mPresenter.loadData((Geo2AddressResultObject)baseObject);
            }
    ...
    @Override
    protected MyLocationPresenter createPresenter() {
    ...
    public void onStatusUpdate(String s, int i, String s1) {
        ...
        LogUtils.sf("location sttus:" + s + ", " + s1 + " " + desc);
    }
}
