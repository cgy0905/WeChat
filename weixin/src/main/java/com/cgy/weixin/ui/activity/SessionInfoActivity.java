...
import com.cgy.weixin.ui.presenter.SessionInfoPresenter;
 ...
 * 会话信息界面
 */
public class SessionInfoActivity extends BaseActivity<ISessionInfoView, SessionInfoPresenter> implements ISessionInfoView{

    public static final int REQ_ADD_MEMBERS = 1000;
    public final static int REQ_REMOVE_MEMBERS = 1001;
    public final static int REQ_SET_GROUP_NAME = 1002;
    ...
    @Bind(R.id.oivGYCordCard)
    OptionItemView mOivGYCordCard;
    ...
    public void initListener() {
        ...
        mOivGYCordCard.setOnClickListener(v -> {
            Intent intent = new Intent(SessionInfoActivity.this, GYCodeCardActivity.class);
            intent.putExtra("groupId", mSessionId);
    ...
    @Override
    protected SessionInfoPresenter createPresenter() {
        return new SessionInfoPresenter(this, mSessionId, mConversationType);
    }
