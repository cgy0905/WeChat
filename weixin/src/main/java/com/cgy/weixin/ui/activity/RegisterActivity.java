...
import com.cgy.weixin.ui.presenter.RegisterPresenter;
...
public class RegisterActivity extends BaseActivity<IRegisterView, RegisterPresenter> implements IRegisterView {
    ...
    Button mBtnSendCode;
    @Bind(R.id.vLineVerifyCode)
    View mVLineVerifyCode;
    ...
    public void initListener() {
        ...
        mEtVerifyCode.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                mVLineVerifyCode.setBackgroundColor(UIUtils.getColor(R.color.green0));
            } else {
                mVLineVerifyCode.setBackgroundColor(UIUtils.getColor(R.color.line));
            }
        });
