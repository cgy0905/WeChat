...
import com.cgy.weixin.ui.activity.CreateGroupActivity;
import com.cgy.weixin.ui.activity.RemoveGroupMemberActivity;
import com.cgy.weixin.ui.activity.SessionInfoActivity;
...
import com.cgy.weixin.ui.view.ISessionInfoView;
...
import static com.cgy.weixin.ui.activity.SessionActivity.SESSION_TYPE_GROUP;
import static com.cgy.weixin.ui.activity.SessionActivity.SESSION_TYPE_PRIVATE;

/**
 * Created by cgy
 * 2018/6/12  11:02
 */
public class SessionInfoPresenter extends BasePresenter<ISessionInfoView> {
    ...
    public SessionInfoPresenter(BaseActivity context, String sessionId, Conversation.ConversationType conversationType) {
        super(context);
    ...
    private void deleteMembersError(Throwable throwable) {
        LogUtils.sf(throwable.getLocalizedMessage());
        mContext.hideWaitingDialog();
        UIUtils.showToast(UIUtils.getString(R.string.del_member_fail));
    }
