...
import com.cgy.weixin.ui.adapter.CommonFragmentPagerAdapter;
import com.cgy.weixin.ui.base.BaseActivity;
import com.cgy.weixin.ui.base.BaseFragment;
import com.cgy.weixin.ui.fragment.FragmentFactory;
import com.cgy.weixin.ui.presenter.MainPresenter;
import com.cgy.weixin.ui.view.IMainView;
...
public class MainActivity extends BaseActivity<IMainView, MainPresenter> implements IMainView,ViewPager.OnPageChangeListener {
    ...
    public void initListener() {
        mIbAddMenu.setOnClickListener(v -> {
            ...
            PopupWindow popupWindow = PopupWindowUtils.getPopupWindowAtLocation(menuView,getWindow().getDecorView(), Gravity.TOP | Gravity.RIGHT,
                    UIUtils.dip2Px(5), mAppBar.getHeight() + 30);
            ...
            menuView.findViewById(R.id.tvScan).setOnClickListener(v12 -> {
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        int deaphaneity_one = (int) (255 * positionOffset);
        int deaphaneity_two = (int) (255 * (1 - positionOffset));
        switch (position) {
            case 0:
                mTvMessageNormal.getBackground().setAlpha(deaphaneity_one);
                mTvMessagePress.getBackground().setAlpha(deaphaneity_two);
                mTvContactsNormal.getBackground().setAlpha(deaphaneity_two);
                mTvContactsPress.getBackground().setAlpha(deaphaneity_one);
                mTvMessageTextNormal.setTextColor(Color.argb(deaphaneity_one, 153, 153, 153));
                mTvMessageTextPress.setTextColor(Color.argb(deaphaneity_two, 69, 192, 26));
                mTvContactsTextNormal.setTextColor(Color.argb(deaphaneity_two, 153, 153, 153));
                mTvContactsTextPress.setTextColor(Color.argb(deaphaneity_one, 69, 192, 26));
                break;
            case 1:
                mTvContactsNormal.getBackground().setAlpha(deaphaneity_one);
                mTvContactsPress.getBackground().setAlpha(deaphaneity_two);
                mTvDiscoveryNormal.getBackground().setAlpha(deaphaneity_two);
                mTvDiscoveryPress.getBackground().setAlpha(deaphaneity_one);
                mTvContactsTextNormal.setTextColor(Color.argb(deaphaneity_one, 153, 153, 153));
                mTvContactsTextPress.setTextColor(Color.argb(deaphaneity_two, 69, 192, 26));
                mTvDiscoveryTextNormal.setTextColor(Color.argb(deaphaneity_two, 153, 153, 153));
                mTvDiscoveryTextPress.setTextColor(Color.argb(deaphaneity_one, 69, 192, 26));
                break;
            case 2:
                mTvDiscoveryNormal.getBackground().setAlpha(deaphaneity_one);
                mTvDiscoveryPress.getBackground().setAlpha(deaphaneity_two);
                mTvMeNormal.getBackground().setAlpha(deaphaneity_two);
                mTvMePress.getBackground().setAlpha(deaphaneity_one);
                mTvDiscoveryTextNormal.setTextColor(Color.argb(deaphaneity_one, 153, 153, 153));
                mTvDiscoveryTextPress.setTextColor(Color.argb(deaphaneity_two, 69, 192, 26));
                mTvMeTextNormal.setTextColor(Color.argb(deaphaneity_two, 153, 153, 153));
                mTvMeTextPress.setTextColor(Color.argb(deaphaneity_one, 69, 192, 26));
                break;
        }
    }
